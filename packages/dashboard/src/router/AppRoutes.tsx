...
const DeploymentDomainsPage = lazy(() => import('#features/deployments/pages/DeploymentDomainsPage'));
const DeploymentEnvVarsPage = lazy(() => import('#features/deployments/pages/DeploymentEnvVarsPage'));
const DeploymentLogsPage = lazy(() => import('#features/deployments/pages/DeploymentLogsPage'));
const DeploymentOverviewPage = lazy(() => import('#features/deployments/pages/DeploymentOverviewPage'));
...
const RealtimePermissionsPage = lazy(() => import('#features/realtime/pages/RealtimePermissionsPage'));
