  ...
  return (
    <div className="flex flex-col gap-3 self-stretch rounded border border-[var(--alpha-8)] bg-card p-6">
      ...
      <p className="text-sm leading-6 text-muted-foreground">
        Connect your Apify account to bring web-scraping results into your backend — your
        data, in your database. You authorize your own Apify account; nothing is shared.
      </p>
      <Button
        variant="primary"
