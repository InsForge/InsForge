...
/**
 * Configuration definition for standard metric cards rendered in the grid.
 */
...
/**
 * Formats a numeric ratio into a percentage string rounded to 1 decimal place.
 *
...
/**
 * Formats a throughput byte count per second into human-readable B/s, KB/s, MB/s, or GB/s.
 *
 * @param value - The numeric throughput in bytes/sec
 * @returns Formatted rate string (e.g. "1.5 MB/s")
 */
...
/**
 * Formats a byte capacity into human-readable byte sizes (B, KB, MB, GB, TB).
 *
 * @param value - The byte count to format
 * @returns Formatted size string (e.g. "4.2 GB")
 */
...
/**
 * The main ObservabilitySection component for displaying project metrics, advisory banners,
 * time-range pickers, and capacity breakdown sparklines.
 */
                  ...
                  capacity={
                    diskCardProps.fixedDomain
                      ? {
                          ...
                          legend: {
                            ceiling: diskCardProps.breakdown
                              ? t('overview.metrics.diskUsed.dataCapacity', {
