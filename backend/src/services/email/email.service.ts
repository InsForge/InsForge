...
export class EmailService {
  ...
  public async sendRaw(options: SendRawEmailRequest): Promise<void> {
    ...
    if (smtpConfig && primaryRecipient) {
      this.checkMinInterval(primaryRecipient, smtpConfig.minIntervalSeconds);
    }
    ...
    if (smtpConfig && primaryRecipient) {
      this.recordEmailSent(primaryRecipient, smtpConfig.minIntervalSeconds);
    }
  }
}
