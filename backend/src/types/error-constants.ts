...
export enum ERROR_CODES {
  ...
  AUTH_DEVICE_AUTHORIZATION_PENDING = 'AUTH_DEVICE_AUTHORIZATION_PENDING',
  AUTH_DEVICE_AUTHORIZATION_DENIED = 'AUTH_DEVICE_AUTHORIZATION_DENIED',
  AUTH_DEVICE_AUTHORIZATION_EXPIRED = 'AUTH_DEVICE_AUTHORIZATION_EXPIRED',
  AUTH_DEVICE_AUTHORIZATION_CONSUMED = 'AUTH_DEVICE_AUTHORIZATION_CONSUMED',
