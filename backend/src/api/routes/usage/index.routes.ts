...
usageRouter.post('/mcp', verifyApiKey, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
usageRouter.get('/mcp', verifyAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
