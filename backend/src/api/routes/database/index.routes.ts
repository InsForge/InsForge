...
router.get('/schemas', verifyAdmin, async (_req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/functions', verifyAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/indexes', verifyAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const schemaName = normalizeDatabaseSchemaName(req.query.schema);
 ...
 */
router.get('/policies', verifyAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const schemaName = normalizeDatabaseSchemaName(req.query.schema);
 ...
 */
router.get('/triggers', verifyAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const schemaName = normalizeDatabaseSchemaName(req.query.schema);
