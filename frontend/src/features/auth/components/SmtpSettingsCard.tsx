        ...
        <div className="mt-8 flex flex-col gap-5">
          ...
          >
            <select
              ...
              className={`flex w-full rounded bg-[var(--alpha-4)] border border-[var(--alpha-12)] p-1.5 text-sm leading-5 text-foreground transition-colors hover:bg-[var(--alpha-8)] focus:outline-none focus:shadow-[0_0_0_1px_rgb(var(--inverse)),0_0_0_2px_rgb(var(--foreground))] ${
