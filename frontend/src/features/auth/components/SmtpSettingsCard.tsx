        ...
        <div className="mt-8 flex flex-col gap-5">
          ...
          >
            <select
              ...
              className={`flex h-9 w-full appearance-none rounded-md border bg-background px-3 py-1 text-sm shadow-sm transition-colors focus:border-primary focus:outline-none ${
                form.formState.errors.port ? 'border-destructive' : 'border-input'
              }`}
            >
