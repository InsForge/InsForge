...
Use this skill for `shared-schemas/` work in the InsForge repository.
...
1. Treat `shared-schemas/` as the source of truth for cross-package payloads.
...
3. Use schema changes as a synchronization trigger.
   ...
   - Update frontend services, hooks, and UI assumptions.
   - Check for import sites in this repo before finishing.
...
- `cd shared-schemas && npm run build`
