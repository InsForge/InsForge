---
title: "TypeScript Email SDK: transactional emails from InsForge"
description: "Send transactional emails from your InsForge project with the TypeScript SDK. Covers the default sender domain, from-name behavior, and Custom SMTP."
---
