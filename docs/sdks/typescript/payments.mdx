...
<Warning>
  Payments is currently in private preview. APIs and behavior may change.
</Warning>
...
<Note>
  See [Payments overview](/core-concepts/payments/overview) for setup and [Payments architecture](/core-concepts/payments/architecture) for routes, tables, webhook projections, and fulfillment patterns.
</Note>
...
Populate those tables from webhook-projected payment state. See [Payments architecture](/core-concepts/payments/architecture) for the projection model.
