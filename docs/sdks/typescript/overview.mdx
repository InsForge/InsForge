---
title: TypeScript and JavaScript SDK for InsForge
description: Install and initialize the official InsForge TypeScript SDK in Node, browsers, and edge runtimes to use auth, database, storage, and realtime.
---
