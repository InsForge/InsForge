...
```bash
# Register a new user
curl -X POST https://your-app.us-east.insforge.app/api/auth/users \
  -H "Content-Type: application/json" \
  -H "x-api-key: your-anon-key" \
  -d '{"email": "user@example.com", "password": "securepassword123"}'

# Sign in and get token
curl -X POST https://your-app.us-east.insforge.app/api/auth/sessions \
  -H "Content-Type: application/json" \
  -H "x-api-key: your-anon-key" \
  -d '{"email": "user@example.com", "password": "securepassword123"}'

# Use the token for authenticated requests
curl https://your-app.us-east.insforge.app/api/database/records/posts \
  -H "x-api-key: your-anon-key" \
