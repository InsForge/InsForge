---
title: "Database REST API: PostgREST-style CRUD, RPC, and SQL"
description: "PostgREST-style REST endpoints for CRUD, filters, RPC functions, RLS policies, migrations, and raw SQL against your InsForge Postgres database."
---
