...
```json
{
  ...
  "redirectUrlWhitelist": ["https://myapp.com/callback", "https://*.myapp.com"],
  "createdAt": "2024-01-15T10:30:00Z",
  "updatedAt": "2024-01-15T10:30:00Z"
}
```
...
| `redirectUrlWhitelist` | string[] | No | Allowed redirect URLs for auth flows (OAuth, email verification). Empty = allow any (dev mode) |
