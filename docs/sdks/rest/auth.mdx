...
```json
{
  ...
  "redirectUrlWhitelist": ["https://myapp.com/dashboard", "https://myapp.com/callback"],
  "createdAt": "2024-01-15T10:30:00Z",
  "updatedAt": "2024-01-15T10:30:00Z"
}
```
...
| `redirectUrlWhitelist` | string[] | No | List of allowed redirect URLs for auth flows (OAuth, email verification). Empty array allows any URL. |
