...
<Update label="Dec 19, 2025" tags={["Multi Region", "Postgres Connection"]}>
  ...
  ## Postgres Connection
  Connect to your project's Postgres database and query it directly from your database clients. This also allows you to integrate InsForge with external services and tools(such as n8n).
