...
AI model credits are included on Pro and Enterprise. Free projects supply their
own [OpenRouter](https://openrouter.ai/keys) key.
...
<AccordionGroup>
  ...
  <Accordion title="How do I check my current usage, and when do the limits reset?">
    ...
    monthly cycle; on Free the allowances are monthly, and AI credits aren't
    among them. Size metrics like database and file storage aren't per-period
    counters — they reflect what you're currently storing, so they go down when
    you delete data.
  </Accordion>
</AccordionGroup>
