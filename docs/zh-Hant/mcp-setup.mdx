...
description: "依編輯器逐步設定 InsForge MCP 伺服器：涵蓋 Cursor、Claude Code、Windsurf、Codex 與 VS Code 的本機安裝步驟與必要先決條件，讓 AI 程式碼助手直接存取後端的資料庫查詢、結構描述管理與儲存空間等能力。找不到工具時可查閱代理目錄。"
---
