---
title: "Kotlin 儲存空間 SDK 參考"
description: "InsForge Kotlin 儲存空間 SDK 參考：使用 upload、uploadWithAutoKey、download 與 delete 管理貯體檔案，支援直接從 Android Uri 上傳，並以 createSignedUrl 與 getDownloadUrl 產生檔案分享連結。"
---
