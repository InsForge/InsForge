---
title: "Kotlin 身份驗證 SDK 參考"
description: "完整介紹 InsForge Kotlin SDK 的身分驗證方法：signUp、signIn、signOut、signInWithOAuthPage 與 getCurrentUser，涵蓋電子郵件驗證、工作階段管理與個人資料設定，適用 Android 與 Kotlin 多平台專案。"
---
