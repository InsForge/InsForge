---
title: "Kotlin AI SDK 參考：模型閘道"
description: "說明 InsForge 模型閘道在 Kotlin 專案的建議架構：由伺服器端使用預先配置的 OpenRouter 金鑰呼叫 LLM，再從 Android 或多平台 App 存取自家後端，涵蓋聊天補全、串流回應、金鑰安全實務與舊版 InsForge AI 方法的遷移指引。"
---
