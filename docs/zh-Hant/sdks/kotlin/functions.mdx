---
title: "Kotlin 函式 SDK 參考"
description: "InsForge Kotlin 函式 SDK 參考：以 invoke 與 invokeRaw 從 Android 或 KMP 應用程式呼叫無伺服器 Edge Function，並涵蓋 listFunctions、createFunction 等管理端方法、錯誤處理與型別化回應模型說明。"
---
