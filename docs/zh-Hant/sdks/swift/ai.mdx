---
title: "Swift AI SDK 參考：模型閘道"
description: "說明在 Apple 平台使用 InsForge 模型閘道的建議架構：由受信任的伺服器端以預先配置的 OpenRouter 金鑰呼叫 LLM，Swift App 僅存取自家後端 API，並整理遺留 InsForge AI 方法的遷移建議與金鑰安全和架構設計的注意事項。"
---
