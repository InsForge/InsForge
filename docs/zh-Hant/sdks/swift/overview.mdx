---
title: "適用於 iOS、macOS、tvOS、watchOS 的 Swift SDK"
description: "介紹官方 InsForge Swift SDK 的安裝與初始化：透過 Swift Package Manager 加入套件並建立用戶端，快速入門範例涵蓋身分驗證、資料庫、儲存與即時模組，並整理 iOS、macOS、tvOS、watchOS 的平台支援與功能模組資訊。"
---
