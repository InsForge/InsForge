---
title: "Swift 資料庫 SDK 參考"
description: "InsForge Swift 資料庫 SDK 參考：以 Codable 模型對 Postgres 資料表執行型別安全的 insert、update、delete、select 與 rpc 呼叫，並詳細列出 PostgREST 篩選器與修飾詞在 Swift 中的寫法。"
---
