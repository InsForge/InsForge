---
title: "Swift 函式 SDK 參考"
description: "InsForge Swift 函式 SDK 參考：使用 invoke 方法及其多載從 iOS、macOS、tvOS 與 watchOS 應用程式安全呼叫無伺服器 Edge Function，示範 Encodable 請求主體、型別化回應解析與完整的錯誤處理方式。"
---
