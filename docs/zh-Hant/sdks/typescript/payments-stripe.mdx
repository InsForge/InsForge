---
title: "Stripe 金流 SDK（TypeScript）"
description: "InsForge Stripe 金流 SDK 參考（TypeScript）：使用 createCheckoutSession 建立一次性與訂閱結帳、createCustomerPortalSession 開啟帳單入口，並說明 RLS 授權、付款狀態讀取與環境切換。"
---
