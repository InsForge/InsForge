---
title: "TypeScript 身分驗證 SDK 參考"
description: "InsForge TypeScript 身分驗證 SDK 參考：詳解 signUp、signInWithPassword、signInWithOAuth、signOut 與 getCurrentUser 等方法的參數、回傳值與範例，涵蓋工作階段管理與使用者資料操作。"
---
