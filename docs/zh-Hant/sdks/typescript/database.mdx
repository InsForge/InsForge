---
title: "TypeScript 資料庫 SDK 參考"
description: "InsForge TypeScript 資料庫 SDK 參考：對 Postgres 資料表執行 insert、update、delete、select 與 rpc 操作，逐一說明各方法的參數、回傳格式與輸出範例，並支援 PostgREST 風格的鏈式篩選與修飾方法。"
---
