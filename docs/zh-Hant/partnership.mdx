---
title: 合作夥伴整合
description: "介紹 InsForge 兩種合作夥伴模式：開發者一鍵即可連接的聯合品牌方案，以及含專案儀表板整合與完整生命週期管理的白標方案，讓您的平台為客戶提供代理原生後端服務，同時享有可擴展基礎架構、彈性整合與帳單分潤等權益。本頁同時說明兩種模式的整合流程、技術架構，以及開始合作的聯繫方式。"
---
