---
title: "常見問題：Edge Function、service_role、非 public schema 與專案暫停"
sidebarTitle: "常見問題"
description: "InsForge 常見問題：Edge Function 與資料庫的差別、相當於 service_role 的 API Key、查詢非 public schema 資料表，以及專案暫停與還原。"
---
