---
title: "InsForge 常見問題：資料庫、非 public schema、Edge Function 與 SDK"
sidebarTitle: "常見問題"
description: "解答 InsForge 常見問題：資料庫呼叫、Edge Function 與 Custom Compute 的差別，如何用 SDK 的 .schema() 查詢非 public schema，以及 RLS 權限設定。"
---
