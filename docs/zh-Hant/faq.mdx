---
title: "常見問題：Edge Function、非 public schema、專案暫停與 CLI 登入"
sidebarTitle: "常見問題"
description: "InsForge 常見問題：Edge Function 與資料庫的差別、查詢非 public schema 資料表、專案暫停與還原、邀請管理員、無瀏覽器環境的 CLI 登入。"
---
