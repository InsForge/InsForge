---
title: "使用 InsForge 建構 Nuxt 應用"
description: "從建立 InsForge 專案開始，完成 CLI 連結與 MCP 編輯器設定後，讓 Cursor 等 AI 助理用單一提示詞產生 Nuxt 應用：安裝 InsForge SDK、加入 Tailwind CSS、建立可公開讀取的 sports 資料表並顯示查詢結果的頁面。"
---
