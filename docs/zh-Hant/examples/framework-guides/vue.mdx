---
title: "使用 InsForge 建構 Vue 應用"
description: "逐步以 InsForge 建構 Vue 應用：先在 insforge.dev 建立專案，接著完成 CLI 連結與各編輯器的 MCP 設定，最後用一段提示詞讓 AI 產生 Vite 加 TypeScript 專案、安裝 InsForge SDK 並從 Postgres 讀取資料呈現。"
---
