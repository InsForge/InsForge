---
title: "使用 InsForge 建構 Svelte 應用"
description: "示範以 InsForge 搭配 AI 工具建構 Svelte 應用：先建立專案、以 npx @insforge/cli link 連結並完成 MCP 設定，再用單一提示詞產生 TypeScript 加 Vite 專案、InsForge SDK 設定與讀取 Postgres 資料庫的元件。"
---
