---
title: "使用 InsForge 建構 Next.js 應用"
description: "建立 InsForge 專案後，透過 CLI 連結與 MCP 設定連接 Cursor 等 AI 編碼工具，只需一段提示詞即可建構含 TypeScript、Tailwind CSS、Postgres 資料表與 /sports 資料頁面的 Next.js 全端應用程式，無需手動編寫程式碼。"
---
