---
title: "使用 InsForge 建構 React 應用"
description: "跟著本指南建立 InsForge 專案、設定 CLI 連結與 MCP，再交給 Cursor 等 AI 工具以一段提示詞打造 React 加 Vite 加 Tailwind 的應用，涵蓋 InsForge SDK 安裝、Postgres 資料表建立與元件的資料串接，全程無需手寫程式碼。"
---
