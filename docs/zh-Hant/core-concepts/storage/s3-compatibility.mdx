---
title: S3 相容閘道
description: "InsForge Storage 於 /storage/v1/s3 提供 S3 相容閘道，以 SigV4 長期金鑰與路徑樣式 URL 支援 aws-cli、AWS SDK 與備份工具直接存取，上傳即時同步至 REST API 與儀表板；金鑰於 Storage 設定頁產生，僅限雲端專案。"
---
