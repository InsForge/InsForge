---
title: "pgvector：Postgres 向量搜尋"
description: "每個 InsForge 專案皆可啟用 pgvector 擴充功能：建立 vector 欄位儲存嵌入、以 HNSW 餘弦索引加速相似度搜尋，並搭配 OpenRouter 的 text-embedding-3-small 與 match_documents RPC 打造語義檢索、推薦與 RAG 應用。"
---
