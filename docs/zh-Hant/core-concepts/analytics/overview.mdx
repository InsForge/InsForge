---
title: "分析：PostHog 驅動的產品洞察"
sidebarTitle: "Overview"
description: "將 PostHog 專案一鍵連接 InsForge 後，即可在儀表板檢視流量 KPI、使用者留存與工作階段回放，並以設定提示讓編碼代理執行 PostHog 精靈、安裝 SDK 完成前端埋點；需深入檢視事件與洞察時可直接深層連結回 PostHog。協助做出資料導向決策。"
---
