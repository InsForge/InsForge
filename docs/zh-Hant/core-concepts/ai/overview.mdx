---
title: "模型閘道：一把金鑰呼叫任意 LLM"
sidebarTitle: "Overview"
description: "InsForge 模型閘道提供 OpenAI 相容端點，經 OpenRouter 路由至 Anthropic、OpenAI、Google 等提供商，單一受管金鑰即可呼叫聊天、串流與嵌入模型，依專案追蹤用量、控管存取並集中計費，應用程式碼無須直接持有提供商金鑰。"
---
