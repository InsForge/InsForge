...
title: "Stripe 付款整合"
sidebarTitle: "Stripe"
description: "在 InsForge 整合 Stripe：伺服器端保管密鑰、建立 Checkout 與 Billing Portal 工作階段、自動註冊 webhook 端點，並將 Products、Prices 與 Subscriptions 鏡像至 payments 資料表以更新使用者訂閱狀態。"
---
