...
description: "在 InsForge 整合 Razorpay：後端建立 Orders 與 Subscriptions、前端開啟 Razorpay Checkout 並驗證簽章，Items、Plans 與付款事件鏡像同步至 payments 結構描述，webhook 需於 Razorpay 儀表板手動註冊。"
---
