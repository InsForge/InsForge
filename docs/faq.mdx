...
<AccordionGroup>
  ...
  <Accordion title="How do I import or load an existing Postgres database into InsForge?">
    ...
    - Once imported, each table is exposed as a REST and SDK endpoint like any other InsForge table. If you'd rather version schema changes in git, see [Database migrations](/core-concepts/database/migrations).
  </Accordion>
