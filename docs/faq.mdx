---
title: "FAQ: Edge Functions, service_role, schemas, project pauses"
sidebarTitle: "FAQ"
description: "Answers to common InsForge questions: Edge Functions vs database, the service_role-equivalent API Key, non-public schemas, and project pauses."
---
