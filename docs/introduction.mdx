...
Required setup. Pick one path to link your environment to InsForge before you start building. Use MCP if your editor speaks it (Claude Code, Cursor, Windsurf, Codex); use the CLI otherwise. You can run both side by side.
