---
title: "InsForge: open-source backend for AI agent coding"
description: "InsForge bundles Postgres, auth, storage, realtime, functions, and a model gateway behind one CLI and MCP server for AI agent coding workflows."
---
