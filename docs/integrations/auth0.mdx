...
3. Select **Regular Web Application** and give it a name (if prompted to select a technology, select **Next.js** or skip — it only affects which quickstart guide Auth0 shows you)
