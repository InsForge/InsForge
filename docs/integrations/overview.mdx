...
description: "Bring your own authentication provider to InsForge. Each provider signs a JWT with your InsForge secret so PostgREST and Row Level Security work natively."
---
