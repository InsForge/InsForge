---
title: "Kinde Authentication for InsForge"
sidebarTitle: "Kinde"
description: "Connect Kinde authentication to your InsForge backend with JWT validation, RLS policies, and user provisioning. Setup in minutes."
---
