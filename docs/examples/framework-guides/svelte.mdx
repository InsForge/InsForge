...
Follow the [MCP installation guide](/quickstart#step-2%3A-install-mcp-server) to connect your AI assistant to your InsForge backend. This allows AI tools like Claude and Cursor to directly interact with your database, storage, and other InsForge services.
