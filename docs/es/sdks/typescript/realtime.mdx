...
description: Suscríbete a canales, publica eventos, rastrea presencia y maneja reconexiones y actualizaciones de tokens a través de Socket.IO con el SDK de TypeScript para InsForge.
---
