---
title: "SDK Email TypeScript: correos transaccionales de InsForge"
description: "Envía correos transaccionales desde tu proyecto de InsForge con el SDK de TypeScript. Incluye dominio remitente por defecto, campo from y SMTP propio."
---
