...
Cargar en una clave de objeto existente reemplaza el objeto actual. Para subir con una clave única generada por el servidor, usa `POST /api/storage/buckets/{bucketName}/objects`.
