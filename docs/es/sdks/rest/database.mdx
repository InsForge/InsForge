---
title: "API REST de base de datos: CRUD estilo PostgREST, RPC y SQL"
description: "Endpoints REST estilo PostgREST para CRUD, filtros, funciones RPC, políticas RLS, migraciones y SQL puro sobre tu base de datos Postgres de InsForge."
---
