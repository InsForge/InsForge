...
description: Instale e inicialice el SDK oficial de Swift de InsForge a través de Swift Package Manager para usar autenticación, base de datos, almacenamiento y funcionalidad en tiempo real en plataformas de Apple.
---
