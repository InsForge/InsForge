---
title: Svelte
description: Aprenda cómo crear un proyecto InsForge y crear una aplicación Svelte usando IA
---

import Installation from '/snippets/sdk-installation.mdx';

Aprenda cómo crear un proyecto InsForge y crear una aplicación Svelte usando herramientas de IA como Cursor.
