...
<Tabs>
  <Tab title="Docker (tu propio host)">
    ...
    Activarlo es un acto deliberado: monta el socket de Docker en el contenedor de InsForge. En tu archivo compose, descomenta la línea que ya están ahí para esto:
