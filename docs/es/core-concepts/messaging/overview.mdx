---
title: "Mensajería: envía email transaccional desde tu proyecto"
sidebarTitle: "Overview"
description: "Envía mensajes transaccionales desde tu proyecto de InsForge. Cubre email hoy, configuración de SMTP para autohosting y SMS y push en la hoja de ruta."
---
...
<Warning>
  **¿Autohospedado?** El remitente gestionado de InsForge Cloud solo está disponible para proyectos vinculados a la nube. En una instancia autohospedada debe configurar [Custom SMTP](/core-concepts/messaging/custom-smtp) antes de que se pueda enviar cualquier correo electrónico, incluidos los de autenticación. Sin él, activar la verificación de correo electrónico deja los nuevos registros atascados en un estado no verificado sin que se entregue ningún correo, porque el fallo de envío se registra y se descarta en lugar de mostrarse. Configure SMTP primero, o deje la verificación de correo electrónico desactivada (el valor por defecto).
</Warning>
