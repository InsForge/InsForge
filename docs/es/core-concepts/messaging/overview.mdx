...
description: "Envíe correos transaccionales desde su proyecto InsForge con el remitente gestionado o SMTP personalizado. Los códigos de inicio de sesión por teléfono ya se envían por SMS; push llegará con la misma API."
---

InsForge Messaging envía notificaciones transaccionales desde su proyecto: recibos, resúmenes, códigos de restablecimiento de contraseña, resúmenes de notificaciones, cualquier cosa para la que de otro modo usaría SendGrid, Postmark o Twilio. El correo electrónico es el primer canal. Los SMS ya están disponibles para los códigos de inicio de sesión por teléfono (consulta [SMS personalizado](/core-concepts/messaging/custom-sms)); una API general de envío de SMS y push están en la hoja de ruta y compartirán la misma superficie API.
