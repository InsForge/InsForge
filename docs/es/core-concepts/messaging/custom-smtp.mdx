---
title: "SMTP propio: enviar email de InsForge por tu SMTP"
description: "Enruta todos los emails salientes de InsForge por tu propio servidor SMTP para los flujos de autenticación y emails.send(). Necesario en autohosting."
---
