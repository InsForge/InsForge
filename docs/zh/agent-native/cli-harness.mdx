---
title: "CLI 工具：代理操作后端的终端接口"
sidebarTitle: "CLI harness"
description: "@insforge/cli 是编码代理操作 InsForge 后端的终端接口：每个命令支持 --json 输出结构化数据，涵盖架构迁移、配置管理、部署、诊断与项目升级删除，让代理无需仪表板即可读取输出、决定下一步并端到端完成后端操作，本页附命令表面一览与典型代理运行示例。"
---
