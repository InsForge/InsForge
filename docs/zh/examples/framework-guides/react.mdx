---
title: "使用 InsForge 构建 React 应用"
description: "从零创建 InsForge 项目并用 Cursor、Claude 等 AI 工具构建 React 单页应用：指南涵盖 @insforge/sdk 安装、身份验证接入、Postgres 数据查询与存储上传等常见任务的提示词与代码示例，帮助你快速完成前端与后端联调。"
---
