---
title: "使用 InsForge 构建 Nuxt 应用"
description: "分步了解如何创建 InsForge 项目并借助 Cursor、Claude 等 AI 工具搭建 Nuxt 3 全栈应用：包含 SDK 安装片段、示例提示词与配置说明，接入身份验证、Postgres 数据库、存储与实时通道，全程由代理生成代码，快速完成从后端到页面的开发。"
---
