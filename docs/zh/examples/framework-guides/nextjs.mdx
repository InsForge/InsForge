---
title: "使用 InsForge 构建 Next.js 应用"
description: "创建 InsForge 项目并用 Cursor、Claude 等 AI 编码工具构建 Next.js 全栈应用的分步指南：涵盖 MCP 连接、构建提示词与 AI 生成内容说明，接入身份验证、Postgres 数据库、存储与实时功能，从零启动到扩展应用，几分钟完成搭建。"
---
