---
title: "使用 InsForge 构建 Svelte 应用"
description: "通过本指南创建 InsForge 项目并使用 Cursor、Claude 等 AI 工具构建 SvelteKit 全栈应用：提供 SDK 安装步骤、AI 提示词与示例代码，接入身份验证、Postgres 数据库、存储与实时更新，几分钟内让 Svelte 应用连上后端。"
---
