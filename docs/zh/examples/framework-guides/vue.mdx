---
title: "使用 InsForge 构建 Vue 应用"
description: "学习创建 InsForge 项目并借助 Cursor、Claude 等 AI 工具开发 Vue 3 应用：指南包含 SDK 安装、身份验证登录、Postgres 数据库查询与实时订阅的提示词与代码示例，帮助你按步骤把 Vue 前端快速接入 InsForge 后端。"
---
