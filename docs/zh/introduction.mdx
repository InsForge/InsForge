---
title: "InsForge：面向 AI 代理编码的开源后端"
description: "InsForge 是面向 AI 代理编码的一体化开源后端：提供 Postgres 数据库、身份验证、存储、实时、边缘函数与 AI 模型网关，编码代理通过 CLI 与 MCP 服务器端到端驱动开发工作流，本页引导你完成首次连接并选择框架开始构建，几分钟即可跑通原型。"
---
