---
title: "常见问题：Edge Function、service_role/API Key、非 public 模式与项目暂停"
sidebarTitle: "常见问题"
description: "InsForge 常见问题：Edge Function 与数据库的区别、相当于 service_role 的 API Key、查询非 public 模式表，以及项目暂停与恢复。"
---
