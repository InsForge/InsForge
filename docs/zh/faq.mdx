---
title: "InsForge 常见问题：数据库、非 public schema、Edge Function 与 SDK"
sidebarTitle: "常见问题"
description: "解答 InsForge 常见问题：数据库调用、Edge Function 与 Custom Compute 的区别，如何用 SDK 的 .schema() 查询非 public schema，以及 RLS 权限设置。"
---
