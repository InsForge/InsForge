---
title: "模型网关：一把托管密钥调用任意 LLM"
sidebarTitle: "Overview"
description: "通过 InsForge 模型网关以一个 OpenAI 兼容端点调用聊天、流式与嵌入模型：流量经 OpenRouter 路由至 OpenAI、Anthropic、Mistral 等提供商，托管密钥让应用代码无需持有任何供应商凭证，并提供按项目配额与用量分析，简化多模型接入。"
---
