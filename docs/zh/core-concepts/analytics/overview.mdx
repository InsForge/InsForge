---
title: "产品分析：PostHog 驱动"
sidebarTitle: "Overview"
description: "将 PostHog 项目连接到 InsForge 后端即可获得产品分析：在 InsForge 仪表板内直接查看页面流量、用户留存与会话回放，追踪用户事件、漏斗与功能标志，无需离开控制台或接入额外埋点服务，几分钟即可为应用接入完整的产品分析能力，数据保留在你的 PostHog 项目中。"
---
