---
title: "数据库迁移"
description: "使用 @insforge/cli 将 migrations/ 目录中的版本化 SQL 文件应用到 InsForge Postgres 数据库：架构变更在 git 中跟踪，每次成功运行都记录到 system.custom_migrations 表，遵循仅向前（forward-only）的迁移工作流。"
---
