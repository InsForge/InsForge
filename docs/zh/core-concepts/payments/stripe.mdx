...
title: "Stripe 支付集成"
sidebarTitle: "Stripe"
description: "在 InsForge 中使用 Stripe 托管 Checkout、Products 与 Prices、Subscriptions 及托管 Billing Portal：涵盖密钥配置、产品目录同步、订阅计划与 Webhook 事件履约，把支付与订阅状态同步到项目的 Postgres 数据库。"
---
