---
title: "Swift 存储 SDK 参考"
description: "InsForge Swift 存储 SDK 参考：从 iOS、macOS、tvOS 与 watchOS 应用使用 upload、download、list 与 delete 管理文件，配置存储桶与上传下载策略，获取公开 URL，并涵盖选项参考与 StoredFile 模型。"
---
