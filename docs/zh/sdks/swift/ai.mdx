---
title: "Swift AI SDK 参考：模型网关"
description: "使用 InsForge 预配的 OpenRouter 密钥从受信任的服务端代码调用任意 LLM，为 iOS、macOS、tvOS 与 watchOS 应用构建 AI 功能，涵盖推荐架构、服务端 OpenRouter 调用、从 Swift 调用后端的示例与遗留 InsForge AI 方法。"
---
