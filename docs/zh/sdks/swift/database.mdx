---
title: "Swift 数据库 SDK 参考"
description: "InsForge Swift 数据库 SDK 参考：通过 Codable 模型对 Postgres 表执行类型安全的 insert、update、delete、select 与 rpc 调用，支持 PostgREST 风格过滤器与修饰符，覆盖 iOS、macOS、tvOS、watchOS。"
---
