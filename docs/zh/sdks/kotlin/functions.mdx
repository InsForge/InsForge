---
title: "Kotlin 函数 SDK 参考"
description: "InsForge Kotlin 函数 SDK 参考：使用 invoke 与 invokeRaw 从 Android 与 Kotlin 多平台应用调用无服务器边缘函数，发送带类型的请求、处理响应与错误，并涵盖管理员函数接口、模型参考章节与集成到业务逻辑的常见模式说明。"
---
