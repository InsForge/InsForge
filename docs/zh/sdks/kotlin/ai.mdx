---
title: "Kotlin AI SDK 参考：模型网关"
description: "使用 InsForge 预配的 OpenRouter 密钥从受信任的服务器端代码调用任意 LLM，为 Android 与 Kotlin 多平台应用构建 AI 功能，涵盖推荐架构、服务器端 OpenRouter 调用示例、从 Kotlin 调用后端的方式与旧版 InsForge AI 方法说明。"
---
