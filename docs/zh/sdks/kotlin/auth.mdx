---
title: "Kotlin 身份验证 SDK 参考"
description: "InsForge Kotlin 身份验证 SDK 参考：使用 signUp、signIn 与 signInWithOAuthPage 实现注册、登录与 OAuth 第三方登录，管理会话与密码重置流程，并从 Android 与 Kotlin 多平台应用读写用户资料与处理认证错误。"
---
