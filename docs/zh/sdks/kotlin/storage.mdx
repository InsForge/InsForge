---
title: "Kotlin 存储 SDK 参考"
description: "InsForge Kotlin 存储 SDK 参考：从 Android 与多平台应用使用 upload、download、list 与 delete 管理文件，通过 createSignedUrl 创建签名 URL 与下载链接，管理存储桶，并涵盖自动生成键名上传与高级上传选项说明。"
---
