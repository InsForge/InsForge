---
title: "TypeScript AI SDK 参考：模型网关"
description: "使用 OpenAI 兼容接口与 InsForge 预配的 OpenRouter 密钥从 TypeScript 应用调用任意 LLM，涵盖创建客户端、聊天补全、流式传输、工具调用、图像与视频生成、嵌入向量、Next.js 路由示例、模型目录与将 InsForge 数据结合 AI 使用的完整参考。"
---
