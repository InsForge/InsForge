...
The fastest way to get started is with Remote MCP. A single command handles installation, authentication, and project binding automatically.
...
Some MCP clients will automatically prompt you to login during setup, while others may require manual authentication steps. Either authentication method will open a browser window where you can login to your InsForge account and grant organization/project access to the MCP client.
...
<AccordionGroup>
  <Accordion title="Cursor">
    ...
    In menu **Preferences → Cursor Setting → Tools & MCP**, you should see InsForge MCP server is added successfully.
    Insorge MCP server is on the status of "Needs authentication", you can click the `connect` button to authenticate.
  </Accordion>
  ...
  <Accordion title="Google Antigravity">
    In **Extensions → MCP Servers - Installed**, you should see InsForge MCP server is added successfully.
    Click the **Manage** button on the InsForge MCP server, select **Start Server** to authenticate.
  </Accordion>
  ...
  <Accordion title="Codex">
    ...
    Alternative, you can run the following command to install the MCP server:
    ```sh
  ...
  <Accordion title="Cline">
    ...
    You can follow the official [Cline documentation](https://docs.cline.bot/mcp/connecting-to-a-remote-server) to add the InsForge MCP server with parameters:
  ...
  <Accordion title="Trae">
    You can follow the official [Trae documentation](https://docs.trae.ai/ide/add-mcp-servers) to add the InsForge MCP server with parameters:
    - Server Name: `insforge`
    - Server URL: `https://mcp.insforge.dev/mcp`
    - Transport Type: `Streamable HTTP`

    After adding the server, you can authenticate by clicking the `Connect` button on the server card.
  </Accordion>
