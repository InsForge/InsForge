...
- An **AI coding assistant** (Cursor, Claude Code, GitHub Copilot, Codex, etc.)
- An **InsForge project** - [create one here](https://insforge.dev) if you haven't already
- A **configured InsForge MCP server** in your coding assistant - confirm that the server is visible in your assistant's MCP settings before you run the verification prompt
![alt text](image.png)
