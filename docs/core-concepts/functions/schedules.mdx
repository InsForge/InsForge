...
Existing schedules created before DNS pinning continue with their previous behavior until they are edited. Saving a schedule with its URL causes InsForge to capture and pin a validated destination for future runs.
