---
title: "Custom Compute: run long-lived containers on Fly.io"
sidebarTitle: "Overview"
description: "Run long-lived containers alongside your InsForge project on Fly.io: queue workers, AI inference loops, websockets, and self-hosting setup."
---
