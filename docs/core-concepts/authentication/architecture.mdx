...
Authentication-sensitive rate limits can be configured by project admins from **Project Settings -> Rate Limits** in the dashboard.
...
- Changes are persisted in backend configuration and applied consistently across restarts.
