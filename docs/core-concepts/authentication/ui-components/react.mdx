...
- Visiting `/sign-in` → Redirects to `https://your-app.region.insforge.app/auth/sign-in`
- Visiting `/sign-up` → Redirects to `https://your-app.region.insforge.app/auth/sign-up`
- Visiting `/forgot-password` → Redirects to `https://your-app.region.insforge.app/auth/forgot-password`
