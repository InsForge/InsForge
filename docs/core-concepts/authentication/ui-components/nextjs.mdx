...
<CardGroup cols={2}>
  ...
  <Card title="5-Minute Setup" icon="clock">
    Provider + API route + Middleware = done
  </Card>
...
1. User clicks "Sign In" → Middleware detects using built-in auth
   ↓
2. Middleware redirects : your-project.insforge.app/auth/signin?redirect=yourapp.com/you-defined-destination-after-sign-in
   ↓
