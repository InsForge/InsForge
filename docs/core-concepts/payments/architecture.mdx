...
|-------------|--------------------|
| `customer.*` | Creates, updates, or marks rows in `payments.customers`; customer deletion removes subject mappings for that Stripe customer. |
...
| `customer.subscription.*` | Creates or updates subscription and subscription item projections. |
