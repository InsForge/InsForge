...
```mermaid
flowchart TB
    Admin["Dashboard or CLI"] --> Payments["InsForge Payments"]
    ...
    style Payments fill:#e0f2fe,stroke:#0284c7,color:#111827
    style Stripe fill:#eef2ff,stroke:#4f46e5,color:#111827
    style Hosted fill:#fef3c7,stroke:#d97706,color:#111827
    style Sync fill:#fef3c7,stroke:#d97706,color:#111827
    style Events fill:#dcfce7,stroke:#16a34a,color:#111827
    style Webhooks fill:#dcfce7,stroke:#16a34a,color:#111827
    style State fill:#ede9fe,stroke:#7c3aed,color:#111827
    style Logic fill:#fee2e2,stroke:#dc2626,color:#111827
    style Tables fill:#fee2e2,stroke:#dc2626,color:#111827
```
...
After a Stripe key is connected, InsForge automatically tries to create the managed Stripe webhook endpoint for that environment. Incoming Stripe events for checkout, invoices, payment intents, refunds, customers, and subscriptions are verified, processed, and recorded automatically. If your backend URL was not public during setup, recreate the endpoint later from the dashboard or CLI.
...
- Create products and prices in Stripe, the dashboard, or with the Payments CLI.
