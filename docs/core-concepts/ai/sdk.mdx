...
Messages support multimodal content (OpenAI-compatible format):
...
// Text + Image
{
  ...
  content: [
    ...
    { type: 'image_url', image_url: { url: 'https://...' } }  // or base64
  ]
}
...
**Supported audio formats:** `wav`, `mp3`, `aiff`, `aac`, `ogg`, `flac`, `m4a`
