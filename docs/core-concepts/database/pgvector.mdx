...
InsForge also provides a built-in [embeddings endpoint](/api-reference/client/generate-embeddings) through the AI gateway, so you can generate and store vectors without configuring external providers.
