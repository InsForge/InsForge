...
```
GET https://{your-project}.{region}.insforge.app/api/oauth/v1/authorize
```
...
```
https://myapp.us-east.insforge.app/api/oauth/v1/authorize?
...
```
POST https://{your-project}.{region}.insforge.app/api/oauth/v1/token
```
...
```
GET https://{your-project}.{region}.insforge.app/auth/v1/profile
...
const config = {
  ...
  insforgeUrl: 'https://yourapp.us-east.insforge.app',
...
app.get('/api/organizations', async (req, res) => {
  ...
  const response = await fetch(`${config.insforgeUrl}/api/organizations`, {
