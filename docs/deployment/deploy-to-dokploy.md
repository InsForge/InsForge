...
description: "Deploy the InsForge backend on Dokploy as a Compose application, with the Postgres image built from the repository so its configuration always matches the release."
---
